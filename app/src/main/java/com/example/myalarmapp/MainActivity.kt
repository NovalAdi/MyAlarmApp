...
import com.example.myalarmapp.adapter.AlarmAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun swipeToDelete(recyclerView: RecyclerView?) {
        ItemTouchHelper(object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Toast.makeText(applicationContext, "Success Delete Alarm", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun initDayToday() {
        val dateNow: Date = Calendar.getInstance().time
        // E = hari, dd = tanggal, mm = bulan, yyyy = tahun
        val dataFormat = SimpleDateFormat("E,dd MM yyyy")
        val formattedDate: String = dataFormat.format(dateNow)
